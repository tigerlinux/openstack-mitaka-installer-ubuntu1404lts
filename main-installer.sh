...
# Version: 1.2.8.ub1404lts "Lynx Pardinus"
# November 19, 2016
#
...
"install")
	...
	echo "Version 1.2.8.ub1404lts \"Lynx Pardinus\" - November 19, 2016"
	echo ""
	echo "I'll verify all requiremens"
	echo "If any requirement is not met, I'll stop and inform what's missing"
	echo ""
	echo "Requirements"
	echo "- OS: Ubuntu Server 14.04 LTS x86_64 fully updated"
	...
	echo "- Ubuntu Cloud Archive OpenStack-MITAKA repository must be enabled and available"
